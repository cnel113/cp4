...
const About = () => {
  return (
    <div className="about-page">
      ...
      <div className="bio">
        <img src={founderImage} alt="Jenny Mastovits"/>
      ...
      <div className="horizonal-container">
        <div className="feature tile">
          ...
          <img src={classicalImage} alt="classical painting"/>
        ...
        <div className="feature tile">
          ...
          <img src={brushImage} alt="paint brushes"/>
        ...
        <div className="feature tile">
          ...
          <img src={potteryImage} alt="people spinning pottery"/>
